...
const DEWARMTE_PROJECT = {
  ...
  areas: [
    {
      id: 'installation-pdfs', name: 'Installationsplan → Materialliste', status: 'active', owner: 'IVA Operations', specVersion: 3,
      summary: 'Öffentliche HTTPS-Links mit optionalem Zusatztext und Zusatz-PDF rein lesend auswerten, Seite 1 immer unverändert als Deckblatt übernehmen und die Materialliste in DeWarmte und HEAT|Hero aufteilen.',
  ...
  automations: [
    {
      ...
      purpose: 'Einen eingefügten Installationsplan-Link mit optionalem Zusatztext und Zusatz-PDF ausschließlich lesen, Seite 1 unverändert als Deckblatt übernehmen, die deutsche Materialliste in DeWarmte und HEAT|Hero aufteilen und die PDF mit sichtbarem Fortschritt in der Projektakte bereitstellen.',
  ...
  phases: [
    ...
    { phase: 2, name: 'PDF erzeugen und prüfen', status: 'active', result: 'Unverändertes Deckblatt plus getrennte Listen für DeWarmte und HEAT|Hero.' },
