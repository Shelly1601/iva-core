...
const DEWARMTE_PROJECT = {
  ...
  areas: [
    {
      id: 'installation-pdfs', name: 'Installationsplan → Materialliste', status: 'active', owner: 'IVA Operations', specVersion: 2,
      summary: 'Öffentliche HTTPS-Links mit optionalem Zusatztext und Zusatz-PDF rein lesend auswerten, die Originalübersicht übernehmen und eine deutsche Materiallisten-PDF erzeugen.',
  ...
  automations: [
    {
      ...
      purpose: 'Einen eingefügten Installationsplan-Link mit optionalem Zusatztext und Zusatz-PDF ausschließlich lesen, Seite 1 unverändert übernehmen, eine deutsche Materialliste erzeugen und die PDF in der Projektakte bereitstellen.',
