...
const HEAT_HERO_PROJECT = {
  ...
  protocolPolicy: {
    ...
    expectedWorkflows: [
      ...
      { workflowId: 'montage-required-fields-morning', workflowName: 'Pipedrive-Pflichtfelder vor Montage prüfen', cadence: 'daily', weekday: null },
      { workflowId: 'planbar-completion-morning', workflowName: 'Planbar Vervollständigung', cadence: 'daily', weekday: null },
      { workflowId: 'manufacturer-leads-wattfox', workflowName: 'Bosch-Herstellerleads und Wattfox', cadence: 'daily', weekday: null },
  ...
  automations: [
    ...
    },
    {
      ...
      execution: 'Railway-Auslöser → ausschließlich iMac · Pipedrive-Hintergrund-API, UI nur als Reparaturweg',
      purpose: 'Deals in Förderung beantragt vor dem Gewonnen-Schritt hart auf E-Mail, Telefonnummer, Anlage und Auftragsnummer prüfen, bestätigte Fälle auf Gewonnen speichern und den erzeugten Deal in Montage einplanen einschließlich Pflichtfeldübernahme verifizieren.',
      safety: 'Keine Statusänderung ohne vollständige, belegte Pflichtfelder und genau eine offizielle KfW-Zusage im richtigen Deal. Speichern, Zielstatus und Zieldeal-Felder werden erneut gelesen; keine Wiederholung auf Verdacht und kein Löschen.',
    ...
    },
    {
      ...
      specVersion: 2,
      name: 'Pipedrive-Pflichtfelder vor Montage prüfen',
      status: 'active',
      enabled: true,
      schedule: 'Täglich · 07:00 Uhr',
      execution: 'iMac · Pipedrive-Hintergrund-API und lokaler IVA-Helfer; UI nur als Reparaturweg',
      purpose: 'Alle offenen Deals bereits in Förderung beantragt und nochmals in Montage einplanen auf E-Mail, Telefonnummer, Anlage und Auftragsnummer prüfen und belegte Leerwerte ergänzen.',
      safety: 'Kontaktdaten nur aus TMB, Anlage nur aus unterschriebenem Angebot; Vaillant Plus/Pro zusätzlich prüfen. Nur eindeutig belegte leere Felder befüllen und per Rücklesung verifizieren. Unvollständige Förderdeals dürfen nicht auf Gewonnen gesetzt werden.',
      nextStep: 'Täglich separat protokollieren und nur über diesen Schalter pausieren.',
    },
    {
      id: 'manufacturer-leads-wattfox',
      specVersion: 1,
      name: 'Bosch-Herstellerleads und Wattfox',
      status: 'active',
      enabled: true,
      schedule: 'Täglich · 21:00 Uhr; freitags zusätzlicher Wochenabgleich',
      execution: 'Railway-Auslöser → ausschließlich iMac · Outlook und Chrome auf dem rechten Display',
      purpose: 'Bosch-Herstellerleads nach Gebiet prüfen, eindeutig angenommene Leads im HeatHero CRM anlegen, Vertriebszuordnung kontrollieren und Wattfox-Rückmeldungen auswerten. Panasonic bleibt im getrennten ProMatch-Lauf.',
      safety: 'Der Lauf ist technisch aktiv, bleibt aber ohne belegten Passwortwechsel, freigegebene Gebiete, bestätigten iMac, Portal-/Outlook-Readiness und erfolgreichen Trockenlauf strikt beobachtend. Wattfox-CRM-Änderungen und Panasonic-Verarbeitung sind hier immer gesperrt.',
      nextStep: 'Läuft täglich um 21:00 Uhr und meldet fehlende Readiness präzise; Schreibaktionen werden erst nach vollständig grünen lokalen Gates zugelassen.',
    },
    {
...
const DEWARMTE_PROJECT = {
  ...
  principles: [
    ...
    'Freier Zusatztext und Zusatz-PDFs dienen nur als Vergleichskontext und werden nach drei Tagen automatisch gelöscht.',
