...
eq('  Pipedrive-Anfrage routet zu Kunden/Backoffice', routeAgent('Suche den Auftrag in Pipedrive').agent.id, 'iva-customer');
eq('  Airtable-Anfrage routet zu Kunden/Backoffice', routeAgent('Lies den Fall in Airtable').agent.id, 'iva-customer');
...
truthy('  Kunden-Agent besitzt direkten Pipedrive-Zugriff', getAgent('iva-customer').allowedSkills.includes('pipedrive'));
truthy('  Kunden-Agent besitzt direkten Airtable-Lesezugriff', getAgent('iva-customer').allowedSkills.includes('airtable'));
