...
check('Sieben Fachrollen sind aktiv', listAgents().filter(agent => agent.enabled).length === 7);
check('Builder und Wissen bleiben gesperrt', !AGENTS['iva-builder'].enabled && !AGENTS['iva-knowledge'].enabled);
