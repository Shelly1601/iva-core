...
export const AGENTS = {
  ...
  'iva-customer': {
    ...
    allowedSkills: ['memory', 'calendar', 'mails', 'crm', 'workspaces', 'qonekto', 'lumit', 'selfImprovement', 'deviceControl', 'planbar'], modelProfile: 'chat', safetyDefault: 'operational', color: 'blue',
  },
  'iva-finance': {
