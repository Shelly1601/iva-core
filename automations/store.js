...
export const AUTOMATION_DEFINITIONS = Object.freeze([
  ...
  { id: 'montage-required-fields-morning', name: 'Pipedrive-Pflichtfelder vor Montage prüfen', category: 'Heat Hero', schedule: 'Täglich · 07:00 Uhr', cron: '0 7 * * *', cadence: 'daily', hour: 7, minute: 0, defaultEnabled: true, maxSlotAttempts: 6, timeoutMs: 120_000, description: 'Prüft offene Deals bereits in Förderung beantragt und nochmals in Montage einplanen auf E-Mail, Telefonnummer, Anlage und Auftragsnummer, ergänzt nur belegte Leerwerte und bleibt bis zum echten lokalen Endstatus offen. Verpasste Slots werden nachgeholt.' },
