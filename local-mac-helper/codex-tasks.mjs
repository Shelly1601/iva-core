...
const PROJECT_WORKFLOW_TASKS = Object.freeze({
  ...
  'kfw-approval-morning': Object.freeze({
    ...
    prompt: 'Lies FUNDING_WORKFLOWS.md vollständig und führe ausschließlich „Förderung 3 – KfW-Zusagen prüfen“ genau einmal auf diesem iMac aus. Prüfe jeden Deal in Förderung beantragt vor dem Gewonnen-Schritt hart auf E-Mail, Telefonnummer, Anlage und Auftragsnummer. Ergänze leere Werte nur aus TMB beziehungsweise unterschriebenem Angebot und lies sie erneut. Setze danach nur Deals mit eindeutig zugeordnetem offiziellen KfW-Zusageschreiben auf Gewonnen, bestätige das Speichern und verifiziere den neu erzeugten offenen Deal in Montage einplanen nochmals auf dieselben Pflichtfelder. Falls die Pipedrive-Automation einen Wert nicht übernommen hat, ergänze ihn im Zieldeal aus demselben Beleg und verifiziere die Speicherung. Nichts löschen.',
    acceptanceCriteria: ['Jeder Statuswechsel besitzt genau eine offizielle eindeutig zugeordnete KfW-Zusage als Beleg.', 'Vor Gewonnen sind E-Mail, Telefonnummer, Anlage und Auftragsnummer vollständig und per Rücklesung bestätigt.', 'Gewonnen, der Übergang nach Montage einplanen und die übernommenen Pflichtfelder im Zieldeal sind nach dem Speichern erneut gelesen.', 'Unklare Fälle bleiben unverändert und werden konkret gemeldet.', 'Nichts wurde gelöscht.'],
  }),
  ...
  'montage-required-fields-morning': Object.freeze({
    title: 'Pipedrive-Pflichtfelder vor Montage prüfen',
    prompt: 'Führe den in AGENTS.md und in der Heat-Hero-Projektautomation „Pipedrive-Pflichtfelder vor Montage prüfen“ beschriebenen Ablauf jetzt genau einmal aus. Lies Pipedrive vorrangig über die offiziellen IVA-Core-Hintergrundbefehle `node local-mac-helper/cli.mjs list-pipedrive-stage "Förderung beantragt"`, `node local-mac-helper/cli.mjs list-pipedrive-stage "Montage einplanen"`, `read-pipedrive-deal` und `download-pipedrive-files`; Browser/UI ist nur der dokumentierte Reparaturweg, wenn der API-Kanal nach konkretem Reparaturversuch nicht verfügbar ist. Prüfe alle offenen Deals in beiden Phasen auf E-Mail, Telefonnummer, Anlage und Auftragsnummer. Telefonnummer und E-Mail stammen aus der TMB, die Anlage einschließlich Hersteller/Leistung aus dem unterschriebenen Angebot; bei Vaillant ist zusätzlich jede belegte Plus-/Pro-Angabe im Ergebnis zu dokumentieren. Ergänze ausschließlich eindeutig belegte leere Felder über `apply-pipedrive-fields ... --commit`, überschreibe keine bestehenden Widersprüche und verifiziere jeden Schreibschritt durch Rücklesung. Ein Deal in Förderung beantragt darf unvollständig nicht auf Gewonnen gesetzt werden. Melde fachlich widersprüchliche Belege separat statt zu raten.',
    acceptanceCriteria: ['Alle offenen Deals in Förderung beantragt und Montage einplanen wurden geprüft.', 'Nur eindeutig belegte leere Pflichtfelder werden ergänzt.', 'Vor dem Gewonnen-Übergang sind E-Mail, Telefonnummer, Anlage und Auftragsnummer vollständig.', 'Bestehende Werte und Widersprüche werden nicht still überschrieben.', 'Ergebnis, Änderungen und manuelle Prüffälle werden protokolliert.'],
  }),
